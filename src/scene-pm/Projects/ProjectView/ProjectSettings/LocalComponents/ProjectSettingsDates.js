          ...
          {project.haEnabled && (
            <>
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.haStart != null
                      ? formik.values.haStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
              ...
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.h2LPredictedStart != null
                      ? formik.values.h2LPredictedStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
          ...
          {project.h2LEnabled && (
            <>
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.h2LStart != null
                      ? formik.values.h2LStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
          ...
          {project.loEnabled && (
            <>
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.loPredictedStart != null
                      ? formik.values.loPredictedStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
              ...
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.loStart != null
                      ? formik.values.loStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
          ...
          {project.spEnabled && (
            <>
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.spPredictedStart != null
                      ? formik.values.spPredictedStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
              ...
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.spStart != null
                      ? formik.values.spStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
          ...
          {project.indEnabled && (
            <>
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.indPredictedStart != null
                      ? formik.values.indPredictedStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
              ...
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.indStart != null
                      ? formik.values.indStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
          ...
          {project.clinicalP1Enabled && (
            <>
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.clinicalP1PredictedStart != null
                      ? formik.values.clinicalP1PredictedStart.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
              ...
              <div className="field grid">
                ...
                <Inplace closable>
                  <InplaceDisplay>
                    {formik.values.clinicalP1Start != null
                      ? formik.values.clinicalP1Start.toLocaleDateString()
                      : "Click to Edit"}
                  </InplaceDisplay>
                  <InplaceContent>
                    <Calendar
