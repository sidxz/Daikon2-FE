...
import FlowDashComments from "./FlowDashComments";

const FlowDashMostRecentComments = () => {
  ...
  let commentsRender = mostRecentComments.map((comment) => {
    return <FlowDashComments key={comment.id} id={comment.id} />;
  });
...
export default observer(FlowDashMostRecentComments);
