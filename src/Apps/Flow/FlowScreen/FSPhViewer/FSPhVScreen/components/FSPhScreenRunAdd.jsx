...
const FSPhScreenRunAdd = ({ screenId, closeSideBar }) => {
      ...
      <form onSubmit={formik.handleSubmit} className="p-fluid">
        ...
        <div className="field">
          ...
          <InputText
            ...
            onChange={formik.handleChange}
            className={classNames({
              "p-invalid": isInvalid("librarySize"),
            })}
          />
          {getErrorMessage("librarySize")}
        </div>
...
export default observer(FSPhScreenRunAdd);
