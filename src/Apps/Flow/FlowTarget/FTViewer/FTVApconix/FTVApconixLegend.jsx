  ...
  return (
    <div className="flex w-10 flex-column gap-2 ">
      ...
      <div className="flex gap-1 w-full">
        ...
        <div className="flex w-full p-2 align-items-left justify-content-left text-base ">
          Drug binding domain occurs in the mammalian off-target, but more than
          1000 X in vitro selectivity toward Mtb target demonstrated
        </div>
      </div>
      <div className="flex gap-1 w-full">
        <div
        ...
        ></div>
        <div className="flex w-full p-2 align-items-left justify-content-left text-base ">
          Drug binding domain not known, less than 1000 X in vitro selectivity
          toward Mtb target demonstrated, or mammalian screen not feasible
        </div>
      </div>
    </div>
  );
