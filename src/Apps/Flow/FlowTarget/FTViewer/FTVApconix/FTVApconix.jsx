    ...
    <div className="flex flex-column min-w-full fadein animation-duration-500 gap-0">
      ...
      <div className="flex w-full">
        <Fieldset className="m-0 w-full" legend="General information">
          ...
          <Formik
            initialValues={{
              mtbTarget: selectedTarget?.mtbTarget,
              ...
              <form onSubmit={handleSubmit} className="p-fluid">
                <div className="flex">
                  ...
                  <div className="field flex items-center gap-3">
                      <label htmlFor="mammalianTarget">Mtb target</label>
                      <InputText
                        id="mtbTarget"
                        value={values.mtbTarget}
                        onChange={handleChange}
                        onBlur={handleBlur}
                      />
                    </div>
                    <div className="field flex items-center gap-3">
                      <label htmlFor="mammalianTarget">Mammalian target</label>
                      <InputText
                        id="mammalianTarget"
                    ...
                    <div className="field flex items-center gap-5">
                      <label htmlFor="mtbDrugBindingDomain">Mtb drug binding domain</label>
                      <InputText
                  ...
                  <div className="field flex items-center gap-3 w-full">
      ...
      <div className="flex w-full">
        <Fieldset className="m-0 w-full" legend="Report Summary">
        <FTVApconixGrid />
        </Fieldset>
      </div>
