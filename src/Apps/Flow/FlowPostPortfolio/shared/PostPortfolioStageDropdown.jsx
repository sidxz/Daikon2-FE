...
const PostPortfolioStageDropdown = ({ readOnlyStage, readOnly = false }) => {
  ...
  const stages = stagePostPortfolioOptions;
  ...
  return (
    <div className="flex">
      ...
      <ConfirmDialog
        ...
        header={`Stage Change Confirmation | ${selectedStage}`}
...
export default observer(PostPortfolioStageDropdown);
