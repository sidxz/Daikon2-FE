...
import AppAdminTargetPromotionTool from "../../screen-admin/AppAdminTargetPromotionTool/AppAdminTargetPromotionTool";
      ...
      <div className="flex flex-column">
        ...
        <div className="flex ml-3 mr-3 fadein animation-duration-1000">
          <Routes>
            ...
            <Route
              path={"target-promotion-tool/*"}
              element={<AppAdminTargetPromotionTool />}
            />
